...
<h1 align="center">Ajouter des réservations</h1>
...
<input type="text"  id="datepicker0" name="dateReservation" placeholder="Ex : 2017-08-01"/>

<br>

<label for="dateArrivee">Date Arrivée</label>
<input type="text"  id="datepicker" name="dateArrivee" placeholder="Ex : 2017-09-01"/>

<br>

<label for="dateDepart">Date Départ</label>
<input type="text" id="datepicker2" name="dateDepart" placeholder="Ex : 2017-09-07"/>
